...
const es = {
  ...
  hero: {
    ...
    scroll: 'Desliza',
    mini: [
      { icon: 'scan', label: 'Diagnóstico integral' },
      { icon: 'leaf', label: 'Resultado natural' },
      { icon: 'spark', label: 'Tecnología actual' },
      { icon: 'shield', label: 'Ambiente privado' },
    ],
  },
  trust: {
    items: [
      { icon: 'heart', title: 'Paciente primero', text: 'La primera valoración es sin compromiso y el plan se explica paso a paso.' },
      { icon: 'award', title: 'Especialistas', text: 'Periodoncia, implantes y armonización orofacial con formación en Brasil.' },
      { icon: 'spark', title: 'Tecnología actual', text: 'Seis suites privadas equipadas con aparatología de última generación.' },
      { icon: 'tag', title: 'Planes a tu medida', text: 'Presupuesto cerrado antes de empezar. Sin sorpresas a mitad de camino.' },
      { icon: 'pin', title: 'En el centro', text: 'Av. 27 de Febrero, en pleno San Pedro de Macorís.' },
    ],
  },
  stats: [
...
const en: Dict = {
  ...
  hero: {
    ...
    ctaSecondary: 'Watch the tour',
    videoTag: 'A walk through the clinic',
    soundOn: 'Turn sound on',
    soundOff: 'Mute',
    scroll: 'Scroll',
    mini: [
      { icon: 'scan', label: 'Complete diagnosis' },
      { icon: 'leaf', label: 'Natural results' },
      { icon: 'spark', label: 'Current technology' },
      { icon: 'shield', label: 'Private setting' },
    ],
  },
  trust: {
    items: [
      { icon: 'heart', title: 'Patient first', text: 'The first assessment carries no commitment and every step is explained.' },
      { icon: 'award', title: 'Specialists', text: 'Periodontics, implants and orofacial harmonization, trained in Brazil.' },
      { icon: 'spark', title: 'Current technology', text: 'Six private suites fitted with latest-generation equipment.' },
      { icon: 'tag', title: 'Plans that fit', text: 'A closed quote before we begin. No surprises halfway through.' },
      { icon: 'pin', title: 'Central location', text: 'Av. 27 de Febrero, in the heart of San Pedro de Macorís.' },
    ],
  },
  stats: [
